...
public class AltaProductos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 102, 51), 1, true));

        jlmensajeOculto.setVisible(false);
        jlmensajeOculto.setFont(new java.awt.Font("Bell MT", 3, 12)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jlmensajeOculto, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
        );
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        if(jtCodigo.getText().isEmpty() || jtDescripcion.getText().isEmpty()
                || jtPrecio.getText().isEmpty()||jtStock.getText().isEmpty() || (jcCategorias.getSelectedItem() == null)){
